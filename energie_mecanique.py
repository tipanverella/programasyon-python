...
def energie_mecanique() -> float:
    ...
    if ask in ("y", "yes", "oui"):
        ...
        ask3 = str(
            input("Voulez-vous avoir un grape pour l'energie cinetique de l'objet?  ")
        )
        ask4 = str(
        ...
        if ask2 in ("y", "yes", "oui"):
            ...
            def graph_epp():
                ...
                print(f"Voici la liste des energies potentielles calculees: {e_potent}.")
        ...
        if ask4 in ("y", "yes", "oui"):
            ...
            plt.grid("equal", axis="bothauteur")
            plt.show()
            plt.close()
    else:
        pass
