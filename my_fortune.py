...
def fortune():
    ...
    if lucky_number in {1, 2}:
        if lucky_number == 1:
            ...
            lucky_quotes = "Today won't be as you expected it, but it'll be woth it. You still can choose a brighter path in your life."
        if my_number in range(50, 101):
            number = int(input("Choose an integer between 1 and 3: "))
            if number == 1:
                print(
                    r"There's is 70% chance that u meet someone that will please you, and make you smile today! :) "
                )
            elif number == 2:
        ...
        lucky_quotes = "You must think about your life, and the choices you are making. The day can be tough."
